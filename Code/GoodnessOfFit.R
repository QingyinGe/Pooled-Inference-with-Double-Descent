...
if(dataset_type == "flu"){
  ...
  save(r2_df, file = "Result/FluGoodnessOfFit_bySeason.RData")
  write.csv(r2_df, "Result/FluGoodnessOfFit_bySeason.csv", row.names = FALSE)
  ...
  save(r2_df, file = "Result/M4GoodnessOfFit_70scenarios.RData")
  write.csv(r2_df, "Result/M4GoodnessOfFit_70scenarios.csv", row.names = FALSE)
